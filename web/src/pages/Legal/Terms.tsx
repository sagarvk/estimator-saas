...
export default function Terms() {
  return (
    <LegalLayout title="Terms & Conditions" updatedAt="01 Janunary 2026">
      <p>
      ...
      <p>
        ...
        EstimatorPro Consultants relationship with you in relation to this
        website.
      </p>

      <p>
        The term <strong>‘EstimatorPro’</strong> or <strong>‘us’</strong> or{" "}
        <strong>‘we’</strong> refers to the owner of the website whose
        registered/operational office is{" "}
        <strong>Shirdi, Rahata, Ahmednagar, Maharashtra</strong>. The term{" "}
      ...
      <ul>
        ...
        <li>
          ...
          document without EstimatorPro Consultants prior written consent.
        </li>
      ...
      <p>
        ...
        <strong>estimatorproconsultants@gmail.com</strong>.
      </p>
