...
export default function SignInForm() {
  ...
  const signInWithEmail = async (e) => {
    ...
    try {
      ...
      // If you want "Keep me logged in" behavior:
      // - Supabase persists session by default in localStorage.
      // - For "not keep", we can do a simple trick: sign in, then if unchecked use sessionStorage.
      // Most apps keep default localStorage always. We'll keep it simple & stable.
      ...
      // Success → redirect is handled by onAuthStateChange, but we can also do:
          ...
          <div>
            ...
            <form onSubmit={signInWithEmail}>
              <div className="space-y-6">
                ...
                <div>
                  <Button className="w-full" size="sm" disabled={loadingGoogle || loadingEmail}>
